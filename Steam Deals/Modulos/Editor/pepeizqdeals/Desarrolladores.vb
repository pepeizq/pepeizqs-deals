    ...
    Module Desarrolladores
        ...
        Private Function CargarLista()
            ...
            Dim lista As New List(Of Desarrollador) From {
                ...
                New Desarrollador("Bandai Namco", "@BandaiNamcoEU", "bandainamco.png", 200),
                New Desarrollador("BadLand Games", "@BadLand_Publish", "badland.png", 290),
                New Desarrollador("Beamdog", "@BeamdogInc", "beamdog.png", 280),
                ...
                New Desarrollador("Fatshark", "@fatsharkgames", "fatshark.png", 240),
                New Desarrollador("Focus Home", "@FocusHome", "focushome.png", 240),
                New Desarrollador("Freebird Games", "@Reives_Freebird", "freebird.png", 340),
                New Desarrollador("Frogwares", "@Frogwares", "frogwares.png", 320),
                New Desarrollador("Frontier", "@frontierdev", "frontier.png", 220),
                New Desarrollador("Frozenbyte", "@Frozenbyte", "frozenbyte.png", 200),
                New Desarrollador("Fruitbat Factory", "@FruitbatFactory", "fruitbatfactory.png", 310),
                New Desarrollador("Funcom", "@funcom", "funcom.png", 280),
                New Desarrollador("Gearbox", "@GearboxOfficial", "gearbox.png", 180),
                New Desarrollador("Good Shepherd", "@GoodShepherdEnt", "goodshepherd.png", 300),
                ...
                New Desarrollador("Humble Games", "@humble", "humblegames.png", 200),
                ...
                New Desarrollador("Jackbox Games", "@jackboxgames", "jackboxgames.png", 330),
                New Desarrollador("Kalypso", "@kalypsomedia", "kalypso.png", 210),
                New Desarrollador("Klei", "@klei", "klei.png", 280),
                New Desarrollador("Koei Tecmo", "@koeitecmoeurope", "koei.png", 150),
                New Desarrollador("Konami", "@Konami", "konami.png", 240),
                New Desarrollador("MangaGamer", "@MangaGamer", "mangagamer.png", 360),
                New Desarrollador("Maximum Games", "@MaximumGames", "maximum.png", 220),
                New Desarrollador("Merge Games", "@MergeGamesLtd", "mergegames.png", 220),
                New Desarrollador("Microids", "@Microids_off", "microids.png", 350),
                New Desarrollador("Milestone", "@milestoneitaly", "milestone.png", 150),
                New Desarrollador("Nacon", "@nacon", "nacon.png", 230),
                New Desarrollador("NeocoreGames", "@NeocoreGames", "neocore.png", 370),
                New Desarrollador("Night Dive", "@NightdiveStudio", "nightdive.png", 320),
                New Desarrollador("NIS America", "@NISAmerica", "nisamerica.png", 240),
                New Desarrollador("Paradox", "@PdxInteractive", "paradox.png", 260),
                New Desarrollador("PLAYISM", "@playismEN", "playsim.png", 330),
                New Desarrollador("PlayStation Studios", "@PlayStation", "playstation.png", 120),
                New Desarrollador("Plug In Digital", "@plugindigital", "plugin.png", 240),
                ...
                New Desarrollador("Rockstar", "@RockstarGames", "rockstar.png", 230),
                New Desarrollador("Runic Games", "@RunicGames", "runicgames.png", 390),
                New Desarrollador("Saber Interactive", "@TweetsSaber", "saber.png", 290),
                New Desarrollador("SCS Software", "@SCSsoftware", "scssoftware.png", 220),
                New Desarrollador("SEGA", "@SEGA", "sega.png", 200),
                New Desarrollador("Slitherine", "@SlitherineGames", "slitherine.png", 210),
                New Desarrollador("SNK", "@SNKPofficial", "snk.png", 300),
                ...
                New Desarrollador("Stardock", "@Stardock", "stardock.png", 390),
                New Desarrollador("Supergiant Games", "@SupergiantGames", "supergiant.png", 270),
                New Desarrollador("Team17", "@Team17", "team17.png", 260),
                New Desarrollador("Techland", "@TechlandGames", "techland.png", 340),
                New Desarrollador("Telltale Games", "@telltalegames", "telltale.png", 300),
                ...
                New Desarrollador("XSEED Games", "@XSEEDGames", "xseed.png", 310)
            }
