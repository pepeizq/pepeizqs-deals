        ...
        Public Function GenerarWeb(listaJuegos As List(Of Oferta), comentario As String, tienda As Tienda)
            ...
            If listaJuegos.Count > 1 Then
                ...
                If comentario.Trim.Length > 0 Then
                    contenido = contenido + "[us_message icon=" + ChrW(34) + "fas|info-circle" + ChrW(34) + " el_class=" + ChrW(34) + "mensajeOfertas" + ChrW(34) + "]<p style=" + ChrW(34) + "font-size: 16px;" + ChrW(34) + ">" + comentario.Trim + "</p>[/us_message]"
                End If
                ...
                For Each juego In listaJuegos
                    ...
                    contenidoJuego = contenidoJuego + "<tr style=" + ChrW(34) + "cursor: pointer;" + ChrW(34) + " title=" + ChrW(34) + tituloFinal + ChrW(34) + " class='clickable-row filaOferta' data-href='" + juego.Enlace + "'>" + Environment.NewLine
