        ...
        Private Async Sub GenerarDatos2(sender As Object, e As RoutedEventArgs)
            ...
            If tbTitulo.Text.Trim.Length > 0 Then
                If tbTitulo.Text.Trim.Contains("•") Then
                    ...
                    tienda = New Tienda(tiendaS, tiendaS, New TiendaLogos(Nothing, imagenTienda.Source, Nothing, imagenTienda.Source, imagenTienda.Source, Nothing), New TiendaNumeraciones(0, 0), Nothing, Nothing, Nothing, Nothing)
