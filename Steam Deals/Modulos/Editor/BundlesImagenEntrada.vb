        ...
        Public Async Sub GenerarJuegos()
            ...
            For Each juego In listaJuegos
                If Not juego.Datos.ID Is Nothing Then
                    fondoCabecera.ImageSource = New BitmapImage(New Uri(Steam_Deals.Ofertas.Steam.listaDominiosImagenes(0) + "/steam/apps/" + juego.Datos.ID + "/page_bg_generated_v6b.jpg"))
                    Exit For
                End If
            Next
