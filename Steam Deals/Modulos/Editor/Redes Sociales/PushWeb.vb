    ...
    Module PushWeb
        ...
        Private Async Sub NavegadorCargaCompleta(sender As Object, e As NavigationEventArgs)
            ...
            If wv.Source.AbsoluteUri.Contains("https://pepeizqdeals.com/wp-login.php?redirect_to=") Then
                ...
                Try
                    Await wv.InvokeScriptAsync("eval", New String() {"document.getElementById('rememberme').focus();"})
                    Await wv.InvokeScriptAsync("eval", New String() {"document.getElementById('rememberme').click();"})
                Catch ex As Exception

                End Try

                Try
                    Await wv.InvokeScriptAsync("eval", New String() {"document.getElementById('wp-submit').focus();"})
                    Await wv.InvokeScriptAsync("eval", New String() {"document.getElementById('wp-submit').click();"})
                Catch ex As Exception
