                ...
                If Not listaJuegosAllyouplay Is Nothing Then
                    If listaJuegosAllyouplay.Juegos.Count > 0 Then
                        For Each juegoAllyouplay In listaJuegosAllyouplay.Juegos
                            ...
                            Dim juego As New Oferta(titulo, descuento, precioRebajado, Nothing, enlace, imagenes, Nothing, tienda.NombreUsar, Nothing, Nothing, DateTime.Today, Nothing, juegobbdd, Nothing, desarrollador)
