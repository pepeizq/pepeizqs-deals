                    ...
                    If Not listaJuegosIG Is Nothing Then
                        If listaJuegosIG.Juegos.Count > 0 Then
                            For Each juegoIG In listaJuegosIG.Juegos
                                ...
                                Dim juego As New Oferta(titulo, descuento, precio, Nothing, enlace, imagenes, drm, tienda.NombreUsar, Nothing, tipo, DateTime.Today, fechaTermina, juegobbdd, Nothing, desarrolladores, Nothing)
