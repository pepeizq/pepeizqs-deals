                ...
                If Not html = Nothing Then
                    ...
                    While j < 25
                        If html.Contains("<article class=" + ChrW(34) + "catalog-item") Then
                            ...
                            Dim juego As New Oferta(titulo, descuento, precioDescontado, Nothing, enlace, imagenes, drm, tienda.NombreUsar, Nothing, Nothing, DateTime.Today, Nothing, juegobbdd, Nothing, Nothing)
