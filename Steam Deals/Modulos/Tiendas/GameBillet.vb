                    ...
                    While k < 36
                        If temp.Contains("grid-item--card") Then
                            ...
                            If temp3.Contains("Pre-order</a>") Then
                                ...
                                Dim juego As New Juego(titulo, "00%", precio, enlace, New JuegoImagenes(imagen, Nothing), drm, Tienda, Nothing, Nothing, DateTime.Today, Nothing, ana, Nothing, Nothing)
                                ...
                                If añadir = True Then
                                    ...
                                    Notificaciones.Toast(juego.Titulo, Nothing)
